...
{
    en->image_enig_fichier = IMG_Load("page.png");
    en->position_enig_fichier.x = 0;
    en->position_enig_fichier.y = 0;
    en->resultat = 0;
    en->correct =IMG_Load("won.png");
    en->wrong =IMG_Load("lose.png");
    en->position_correct.x = 0;
    en->position_correct.y = 0;
    en->position_wrong.x = 0;
    en->position_wrong.y = 0;
...
Mix_AllocateChannels(1);
    ...
    music1 = Mix_LoadWAV("music/victory.wav");
...
int enig_fichier_avec_fichier(SDL_Surface * screen){
