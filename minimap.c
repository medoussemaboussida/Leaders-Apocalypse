...
{
m->img_map=IMG_Load("minimap s1.png");//minimap
m->img_joueur=IMG_Load("images/minip.png");
...
SDL_Rect MAJMinimap2 (SDL_Rect Posjoueur,int redemensionement,SDL_Rect camera)////////pos absoluee
{
SDL_Rect pos_joueur;
pos_joueur.x= ((camera.x +Posjoueur.x)*redemensionement)/100;
pos_joueur.y= 20+((camera.y +Posjoueur.y)*redemensionement)/100;
